...
| File | What it is |
|------|-----------|
| `proving-nothing.md` | The full manuscript in Markdown (~5,280 lines) |
| `proving-nothing.pdf` | Pre-built PDF with Midnight dark-mode branding |
| `proving-nothing.tex` | Intermediate LaTeX generated by Pandoc |
